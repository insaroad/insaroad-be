 ...
 */
package com.pbl.insaroad.global.s3.controller;
...
import com.pbl.insaroad.global.s3.service.S3Service;
...
public class S3Controller {
  ...
  @Operation(summary = "S3 이미지 URL 기반 삭제 API", description = "전체 URL을 기반으로 이미지를 삭제합니다.")
  @DeleteMapping("/image-delete-by-url")
  public ResponseEntity<BaseResponse<String>> deleteFileByUrl(@RequestParam String fileUrl) {
    s3Service.deleteFileByUrl(fileUrl);
    return ResponseEntity.ok(BaseResponse.success("이미지 삭제에 성공했습니다."));
  }
}
